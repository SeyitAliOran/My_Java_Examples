package dersler.gun58_Collections_List.Stack;
...
public class StackDemo {
    public static void main(String[] args) {
        ...
        System.out.println("stackColors.pop() = " + stackColors.pop()); //Removes and returns the top element of the stack
        System.out.println("stackColors = " + stackColors);
        System.out.println("stackColors.pop() = " + stackColors.pop());
        System.out.println("stackColors = " + stackColors);
        System.out.println("stackColors.peek() = " + stackColors.peek()); //Returns the top element of the stack
        System.out.println("stackColors = " + stackColors);

        System.out.println("stackColors.empty() = " + stackColors.empty()); //Returns true if stack empty
    }
}
